              ...
              (value: string, ...capture: string[]) => {
                ...
                if (value.startsWith("!")) {
                  ...
                  if ([".png", ".jpg", ".jpeg", ".gif", ".bmp", ".svg", ".webp"].includes(ext)) {
                    ...
                    return {
                      type: "html",
                      value: `<figure class="interactive-widget"><div class="widget-shell"><iframe src="${widgetUrl}" class="widget-frame widget-frame-inert" tabindex="-1" aria-hidden="true" loading="lazy"></iframe><button class="widget-activate" type="button" aria-label="Activate interactive widget" aria-expanded="false"><span>Click to interact</span></button></div>${caption}</figure>`,
                    }
                  } else {
                    const block = anchor
                    return {
